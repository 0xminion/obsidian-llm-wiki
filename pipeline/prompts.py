...
def build_entry_prompt(
    ...
    return (
        ...
        "\n"
        "## Linked Concepts\n"
        "Cross-reference with relevant concepts from the context below using [[wikilinks]].\n"
        "\n"
        "**Requirements:**\n"
        ...
        "- Include ^[source_filename.md] citations on paragraphs that reference "
        "specific claims from the source.\n"
        "- Use the source title as the citation filename.\n"
        "\n"
        "--- CONCEPT CONTEXT ---\n"
        f"{concept_context}\n"
        "\n"
...
def build_concept_prompt(
    ...
    return (
        ...
        "- Cross-reference with [[wikilinks]] to related concepts.\n"
